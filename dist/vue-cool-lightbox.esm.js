...
var script = {
  ...
  watch: {
    ...
    showThumbs: function showThumbs(prev, val) {
      ...
      if (this.showThumbs) {
        var activeThumbnail = document.querySelector('.cool-lightbox__thumb.active');
  ...
  methods: {
    ...
    bottomFocus: function bottomFocus() {
      if (this.showThumbs) {
        var firstThumbnail = document.querySelector('.cool-lightbox__thumb');
    ...
    bottomThumbFocus: function bottomThumbFocus() {
      this.hasPreviousButton 
            ? this.$refs.firstNavButton.focus() 
            : this.$refs.lastNavButton.focus();
    },
    thumbFocusFromNav: function thumbFocusFromNav() {
      var thumbnails = document.querySelectorAll('.cool-lightbox__thumb');
